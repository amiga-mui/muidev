...
* [Pixmap.mui](MUI_Pixmap)
* [Rectangle.mui](MUI_Rectangle)
* [Scale.mui](MUI_Scale)
* [String.mui](MUI_String)
* [Text.mui](MUI_Text)
## Background
...
[MUIA_InputMode](MUI_Area/#MUIA_InputMode), you can make it behave like a button or like a toggle
...
## MUIA_Background
### NAME
[MUIA_Background](MUI_Area/#MUIA_Background) -- V4 [IS.], `LONG`, 0x8042545b
...
This attribute takes the same values as [MUIA_Image_Spec](MUI_Image/#MUIA_Image_Spec), please refer to
...
inheritance can be activated by setting [MUIA_Background](MUI_Area/#MUIA_Background) to an empty
...
## MUIA_BottomEdge
### NAME
[MUIA_BottomEdge](MUI_Area/#MUIA_BottomEdge) -- V4 [..G], `LONG`, 0x8042e552
...
### SEE ALSO
[MUIA_TopEdge](MUI_Area/#MUIA_TopEdge), [MUIA_Width](MUI_Area/#MUIA_Width), [MUIA_Height](MUI_Area/#MUIA_Height), [MUIA_RightEdge](MUI_Area/#MUIA_RightEdge), [MUIA_LeftEdge](MUI_Area/#MUIA_LeftEdge)

## MUIA_ContextMenu
### NAME
[MUIA_ContextMenu](MUI_Area/#MUIA_ContextMenu) -- V11 [ISG], `Object *`, 0x8042b704
...
Note: MUI will **NOT** dispose the [MUIA_ContextMenu](MUI_Area/#MUIA_ContextMenu) object when the object is
disposed. You must take care of the menustrip object yourself. This is
because menustrip objects in [MUIA_ContextMenu](MUI_Area/#MUIA_ContextMenu) do not actually "belong" to
their parent objects, they're just a "reference". You are allowed to use a
single menustrip object as [MUIA_ContextMenu](MUI_Area/#MUIA_ContextMenu) for different objects of the
...
[MUIM_ContextMenuChoice](MUI_Area/#MUIM_ContextMenuChoice) method containing the selected menuitem object. If
...
immediately take approriate actions when receiving [MUIM_ContextMenuChoice](MUI_Area/#MUIM_ContextMenuChoice).

If you don't have a subclass or don't override [MUIM_ContextMenuChoice](MUI_Area/#MUIM_ContextMenuChoice), the
method will finally reach Area class and will set the attribute
[MUIA_ContextMenuTrigger](MUI_Area/#MUIA_ContextMenuTrigger) to the appropriate menuitem object. This allows you
...
See [MUIM_ContextMenuBuild](MUI_Area/#MUIM_ContextMenuBuild) for details.
...
### SEE ALSO
[MUIA_ContextMenuHook](MUI_Area/#MUIA_ContextMenuHook), [MUIA_ContextMenuTrigger](MUI_Area/#MUIA_ContextMenuTrigger), [MUIM_ContextMenuChoice](MUI_Area/#MUIM_ContextMenuChoice),
[MUIM_ContextMenuBuild](MUI_Area/#MUIM_ContextMenuBuild)

## MUIA_ContextMenuHook
### NAME
[MUIA_ContextMenuHook](MUI_Area/#MUIA_ContextMenuHook) -- V20 [ISG], `struct Hook *`, 0x80427c6e
...
mouse position. In addition [MUIA_ContextMenu](MUI_Area/#MUIA_ContextMenu) **MUST** be set to TRUE to
...
disposed. You must take care of the menustrip object yourself. This is
because menustrip objects from [MUIA_ContextMenuHook](MUI_Area/#MUIA_ContextMenuHook) do not actually "belong"
...
### SEE ALSO
[MUIA_ContextMenu](MUI_Area/#MUIA_ContextMenu), [MUIA_ContextMenuTrigger](MUI_Area/#MUIA_ContextMenuTrigger), [MUIM_ContextMenuBuild](MUI_Area/#MUIM_ContextMenuBuild)

## MUIA_ContextMenuTrigger
### NAME
[MUIA_ContextMenuTrigger](MUI_Area/#MUIA_ContextMenuTrigger) -- V11 [..G], `Object *`, 0x8042a2c1

### FUNCTION
Allows reacting on context menus with notificaton. When the
[MUIM_ContextMenuChoice](MUI_Area/#MUIM_ContextMenuChoice) method reaches Area class because you did not
override it in a subclass, it sets [MUIA_ContextMenuTrigger](MUI_Area/#MUIA_ContextMenuTrigger) to the received
parameter which is a pointer to the user-selected menuitem object.

See [MUIA_ContextMenu](MUI_Area/#MUIA_ContextMenu) for details.

### SEE ALSO
[MUIA_ContextMenu](MUI_Area/#MUIA_ContextMenu), [MUIM_ContextMenuChoice](MUI_Area/#MUIM_ContextMenuChoice), [MUIM_ContextMenuBuild](MUI_Area/#MUIM_ContextMenuBuild)

## MUIA_ControlChar
### NAME
[MUIA_ControlChar](MUI_Area/#MUIA_ControlChar) -- V4 [ISG], `char`, 0x8042120b
...
## MUIA_CycleChain
### NAME
[MUIA_CycleChain](MUI_Area/#MUIA_CycleChain) -- V11 [ISG], `LONG`, 0x80421ce7

### FUNCTION
MUI 3 introduces a new keyboard cycle chain system. All you have to do is to
set  [MUIA_CycleChain](MUI_Area/#MUIA_CycleChain) to 1 for every object that you want to have in your
chain, MUI does the rest automatically. The old [MUIM_Window_SetCycleChain](MUI_Window/#MUIM_Window_SetCycleChain)
...
## MUIA_Disabled
### NAME
[MUIA_Disabled](MUI_Area/#MUIA_Disabled) -- V4 [ISG], `BOOL`, 0x80423661
...
Using [MUIA_Disable](MUI_Area/#MUIA_Disable) on a group of objects will disable all objects within
that group.
...
## MUIA_DoubleBuffer
### NAME
[MUIA_DoubleBuffer](MUI_Area/#MUIA_DoubleBuffer) -- V20 [ISG], `BOOL`, 0x8042a9c7

### FUNCTION
Setting this to TRUE will enable a doublebuffer for this objects [MUIM_Draw](MUI_Area/#MUIM_Draw)
method.
...
calling [MUIM_Draw](MUI_Area/#MUIM_Draw), your object's normal muiRenderInfo(obj) pointer (which
...
Your [MUIM_Draw](MUI_Area/#MUIM_Draw) method can then render as it would normally do, there is no
...
_left/_top in [MUIM_HandleEvent](MUI_Area/#MUIM_HandleEvent) from imsg->MouseX/Y before storing the
coordinates (ie make them relative to your objects origin) and then, when using
them in your [MUIM_Draw](MUI_Area/#MUIM_Draw) method, add _left/_top(obj) again. This will ensure
everything ends up at its place regardless whether you use [MUIA_DoubleBuffer](MUI_Area/#MUIA_DoubleBuffer) or
not.
...
as flawlessly with [MUIA_DoubleBuffer](MUI_Area/#MUIA_DoubleBuffer)=TRUE as with [MUIA_DoubleBuffer](MUI_Area/#MUIA_DoubleBuffer)=FALSE.

## MUIA_DoubleClick
### NAME
[MUIA_DoubleClick](MUI_Area/#MUIA_DoubleClick) -- V20 [..G], `BOOL`, 0x8042f057
...
## MUIA_Draggable
### NAME
[MUIA_Draggable](MUI_Area/#MUIA_Draggable) -- V11 [ISG], `BOOL`, 0x80420b6e
...
## MUIA_Dropable
### NAME
[MUIA_Dropable](MUI_Area/#MUIA_Dropable) -- V11 [ISG], `BOOL`, 0x8042fbce
...
D&D actions, because the [MUIM_DragQuery](MUI_Area/#MUIM_DragQuery) method is answered FALSE when it
arrives at Area class.

### SEE ALSO
[MUIM_DragQuery](MUI_Area/#MUIM_DragQuery)

## MUIA_ExportID
### NAME
[MUIA_ExportID](MUI_Area/#MUIA_ExportID) -- V4 [ISG], `ULONG`, 0x8042d76e **(OBSOLETE)**

### FUNCTION
Obsolete. See Notify.mui/[MUIA_ObjectID](MUI_Notify/#MUIA_ObjectID)

### NOTES
This attribute was renamed to [MUIA_ObjectID](MUI_Notify/#MUIA_ObjectID) and moved to Notify class in
muimaster.library V12.

### SEE ALSO
[MUIA_ObjectID](MUI_Notify/#MUIA_ObjectID), [MUIM_Application_Load](MUI_Application/#MUIM_Application_Load), [MUIM_Application_Save](MUI_Application/#MUIM_Application_Save)

## MUIA_FillArea
### NAME
[MUIA_FillArea](MUI_Area/#MUIA_FillArea) -- V4 [IS.], `BOOL`, 0x804294a3

### FUNCTION
Set this to FALSE if you are a custom class and don't want Area class to
clear your background during the DoSuperMethod() in your [MUIM_Draw](MUI_Area/#MUIM_Draw) method.
Note that if you set this, your [MUIM_Draw](MUI_Area/#MUIM_Draw) method is responsible for filling
every pixel of your objects rectangle, otherwise some display trash will
remain there.

## MUIA_FixHeight
### NAME
[MUIA_FixHeight](MUI_Area/#MUIA_FixHeight) -- V4 [I..], `LONG`, 0x8042a92b
...
### SEE ALSO
[MUIA_FixWidth](MUI_Area/#MUIA_FixWidth), [MUIA_FixWidthTxt](MUI_Area/#MUIA_FixWidthTxt), [MUIA_FixHeightTxt](MUI_Area/#MUIA_FixHeightTxt)

## MUIA_FixHeightTxt
### NAME
[MUIA_FixHeightTxt](MUI_Area/#MUIA_FixHeightTxt) -- V4 [I..], `STRPTR`, 0x804276f2
...
### SEE ALSO
[MUIA_FixHeight](MUI_Area/#MUIA_FixHeight), [MUIA_FixWidth](MUI_Area/#MUIA_FixWidth), [MUIA_FixWidthTxt](MUI_Area/#MUIA_FixWidthTxt)

## MUIA_FixWidth
### NAME
[MUIA_FixWidth](MUI_Area/#MUIA_FixWidth) -- V4 [I..], `LONG`, 0x8042a3f1
...
### SEE ALSO
[MUIA_FixHeight](MUI_Area/#MUIA_FixHeight), [MUIA_FixWidthTxt](MUI_Area/#MUIA_FixWidthTxt), [MUIA_FixHeightTxt](MUI_Area/#MUIA_FixHeightTxt)

## MUIA_FixWidthTxt
### NAME
[MUIA_FixWidthTxt](MUI_Area/#MUIA_FixWidthTxt) -- V4 [I..], `STRPTR`, 0x8042d044
...
### SEE ALSO
[MUIA_FixHeight](MUI_Area/#MUIA_FixHeight), [MUIA_FixWidth](MUI_Area/#MUIA_FixWidth), [MUIA_FixHeightTxt](MUI_Area/#MUIA_FixHeightTxt)

## MUIA_Floating
### NAME
[MUIA_Floating](MUI_Area/#MUIA_Floating) -- V20 [ISG], `BOOL`, 0x80429753
...
object's classes should implement [MUIM_Layout](MUI_Area/#MUIM_Layout) to ensure a proper layout.
...
### SEE ALSO
[MUIM_Layout](MUI_Area/#MUIM_Layout)

## MUIA_Font
### NAME
[MUIA_Font](MUI_Area/#MUIA_Font) -- V4 [ISG], `struct TextFont *`, 0x8042be50
...
## MUIA_Frame
### NAME
[MUIA_Frame](MUI_Area/#MUIA_Frame) -- V4 [I..], `LONG`, 0x8042ac64
...
user adjustable as long as you don't override them with one of [MUIA_InnerLeft](MUI_Area/#MUIA_InnerLeft),
[MUIA_InnerRight](MUI_Area/#MUIA_InnerRight), [MUIA_InnerTop](MUI_Area/#MUIA_InnerTop) or [MUIA_InnerBottom](MUI_Area/#MUIA_InnerBottom).

Starting with version 20 of muimaster.library, you can also pass a pointer to a
struct MUI_FrameSpec as [MUIA_Frame](MUI_Area/#MUIA_Frame). This allows the use of customized frames
adjustable with the Frameadjust class custom class. Note that the pointer to the
passed MUI_FrameSpec must remain valid until you overwrite [MUIA_Frame](MUI_Area/#MUIA_Frame) with
...
### NOTES
The first object in a window ([MUIA_Window_RootObject](MUI_Window/#MUIA_Window_RootObject)) can **NOT** have a
...
### SEE ALSO
[MUIA_InnerLeft](MUI_Area/#MUIA_InnerLeft), [MUIA_InnerRight](MUI_Area/#MUIA_InnerRight), [MUIA_InnerTop](MUI_Area/#MUIA_InnerTop), [MUIA_InnerBottom](MUI_Area/#MUIA_InnerBottom)

## MUIA_FrameDynamic
### NAME
[MUIA_FrameDynamic](MUI_Area/#MUIA_FrameDynamic) -- V20 [ISG], `BOOL`, 0x804223c9
...
the object. Best use the attribute together with [MUIA_FrameVisible](MUI_Area/#MUIA_FrameVisible) set to
FALSE to make the frame invisible by default.

Defaults to FALSE.

### SEE ALSO
[MUIA_Frame](MUI_Area/#MUIA_Frame), [MUIA_FrameVisible](MUI_Area/#MUIA_FrameVisible)

## MUIA_FramePhantomHoriz
### NAME
[MUIA_FramePhantomHoriz](MUI_Area/#MUIA_FramePhantomHoriz) -- V4 [I..], `BOOL`, 0x8042ed76
...
## MUIA_FrameTitle
### NAME
[MUIA_FrameTitle](MUI_Area/#MUIA_FrameTitle) -- V4 [ISG], `STRPTR`, 0x8042d1c7
...
You may not use [MUIA_FrameTitle](MUI_Area/#MUIA_FrameTitle) without defining a [MUIA_Frame](MUI_Area/#MUIA_Frame).
...
### SEE ALSO
[MUIA_Frame](MUI_Area/#MUIA_Frame)

## MUIA_FrameVisible
### NAME
[MUIA_FrameVisible](MUI_Area/#MUIA_FrameVisible) -- V20 [ISG], `BOOL`, 0x80426498
...
### SEE ALSO
[MUIA_Frame](MUI_Area/#MUIA_Frame), [MUIA_FrameDynamic](MUI_Area/#MUIA_FrameDynamic)

## MUIA_Height
### NAME
[MUIA_Height](MUI_Area/#MUIA_Height) -- V4 [..G], `LONG`, 0x80423237
...
### SEE ALSO
[MUIA_TopEdge](MUI_Area/#MUIA_TopEdge), [MUIA_Width](MUI_Area/#MUIA_Width), [MUIA_LeftEdge](MUI_Area/#MUIA_LeftEdge), [MUIA_RightEdge](MUI_Area/#MUIA_RightEdge), [MUIA_BottomEdge](MUI_Area/#MUIA_BottomEdge)

## MUIA_HorizDisappear
### NAME
[MUIA_HorizDisappear](MUI_Area/#MUIA_HorizDisappear) -- V11 [ISG], `LONG`, 0x80429615
...
### SEE ALSO
[MUIA_VertDisappear](MUI_Area/#MUIA_VertDisappear), [MUIM_Group_GetChild](MUI_Group/#MUIM_Group_GetChild)

## MUIA_HorizWeight
### NAME
[MUIA_HorizWeight](MUI_Area/#MUIA_HorizWeight) -- V4 [ISG], `WORD`, 0x80426db9

### FUNCTION
Adjust the horizontal weight of an object. Usually you can simply use
[MUIA_Weight](MUI_Area/#MUIA_Weight) instead of this tag but in some two-dimensional groups it may
become handy to have different horizontal and vertical weights.

### SEE ALSO
[MUIA_Weight](MUI_Area/#MUIA_Weight)

## MUIA_InnerBottom
### NAME
[MUIA_InnerBottom](MUI_Area/#MUIA_InnerBottom) -- V4 [I.G], `LONG`, 0x8042f2c0
...
## MUIA_InnerLeft
### NAME
[MUIA_InnerLeft](MUI_Area/#MUIA_InnerLeft) -- V4 [I.G], `LONG`, 0x804228f8
...
## MUIA_InnerRight
### NAME
[MUIA_InnerRight](MUI_Area/#MUIA_InnerRight) -- V4 [I.G], `LONG`, 0x804297ff
...
## MUIA_InnerTop
### NAME
[MUIA_InnerTop](MUI_Area/#MUIA_InnerTop) -- V4 [I.G], `LONG`, 0x80421eb6
...
## MUIA_InputMode
### NAME
[MUIA_InputMode](MUI_Area/#MUIA_InputMode) -- V4 [I..], `LONG`, 0x8042fb04
...
attributes [MUIA_Selected](MUI_Area/#MUIA_Selected), [MUIA_Pressed](MUI_Area/#MUIA_Pressed) and [MUIA_Timer](MUI_Area/#MUIA_Timer). See their
...
### SEE ALSO
[MUIA_Selected](MUI_Area/#MUIA_Selected), [MUIA_Timer](MUI_Area/#MUIA_Timer), [MUIA_Pressed](MUI_Area/#MUIA_Pressed)

## MUIA_KnowsDisabled
### NAME
[MUIA_KnowsDisabled](MUI_Area/#MUIA_KnowsDisabled) -- V20 [ISG], `BOOL`, 0x8042deef

### FUNCTION
Usually MUI will take care to draw a suitable disable pattern for objects
which have [MUIA_Disabled](MUI_Area/#MUIA_Disabled) set to TRUE. However, if your class knows a special
...
## MUIA_LeftEdge
### NAME
[MUIA_LeftEdge](MUI_Area/#MUIA_LeftEdge) -- V4 [..G], `LONG`, 0x8042bec6
...
### SEE ALSO
[MUIA_TopEdge](MUI_Area/#MUIA_TopEdge), [MUIA_Width](MUI_Area/#MUIA_Width), [MUIA_Height](MUI_Area/#MUIA_Height), [MUIA_RightEdge](MUI_Area/#MUIA_RightEdge), [MUIA_BottomEdge](MUI_Area/#MUIA_BottomEdge)

## MUIA_MaxHeight
### NAME
[MUIA_MaxHeight](MUI_Area/#MUIA_MaxHeight) -- V11 [I..], `LONG`, 0x804293e4

### FUNCTION
Specify a maximum height for an object (in pixels).

### SEE ALSO
[MUIA_MaxWidth](MUI_Area/#MUIA_MaxWidth), [MUIA_FixWidth](MUI_Area/#MUIA_FixWidth), [MUIA_FixHeight](MUI_Area/#MUIA_FixHeight)

## MUIA_MaxWidth
### NAME
[MUIA_MaxWidth](MUI_Area/#MUIA_MaxWidth) -- V11 [I..], `LONG`, 0x8042f112

### FUNCTION
Specify a maximum width for an object (in pixels).

### SEE ALSO
[MUIA_MaxHeight](MUI_Area/#MUIA_MaxHeight), [MUIA_FixWidth](MUI_Area/#MUIA_FixWidth), [MUIA_FixHeight](MUI_Area/#MUIA_FixHeight)

## MUIA_MinHeight
### NAME
[MUIA_MinHeight](MUI_Area/#MUIA_MinHeight) -- V20 [I..], `LONG`, 0x8042c04a
...
Area class and overload the [MUIM_AskMinMax](MUI_Area/#MUIM_AskMinMax) method to enforce a certain minimum
height.

### SEE ALSO
[MUIA_MinWidth](MUI_Area/#MUIA_MinWidth)

## MUIA_MinWidth
### NAME
[MUIA_MinWidth](MUI_Area/#MUIA_MinWidth) -- V20 [I..], `LONG`, 0x80424342
...
or Area class and overload the [MUIM_AskMinMax](MUI_Area/#MUIM_AskMinMax) method to enforce a certain
minimum width.

### SEE ALSO
[MUIA_MinHeight](MUI_Area/#MUIA_MinHeight)

## MUIA_PointerType
### NAME
[MUIA_PointerType](MUI_Area/#MUIA_PointerType) -- V20 [ISG], `LONG`, 0x8042b467
...
### FUNCTION
[MUIA_PointerType](MUI_Area/#MUIA_PointerType) defines the built-in mouse pointer to be used when the
...
[MUIM_WhichPointerType](MUI_Area/#MUIM_WhichPointerType) and return the desired pointer type value.
...
### SEE ALSO
[MUIM_WhichPointerType](MUI_Area/#MUIM_WhichPointerType)

## MUIA_Pressed
### NAME
[MUIA_Pressed](MUI_Area/#MUIA_Pressed) -- V4 [..G], `BOOL`, 0x80423535

### FUNCTION
Learn if a button is pressed (or released). The [MUIA_Pressed](MUI_Area/#MUIA_Pressed) attribute of a
...
MUIV_InputMode_Immediate:
   - undefined, use [MUIA_Selected](MUI_Area/#MUIA_Selected) for this.

MUIV_InputMode_Toggle:
   - undefined, use [MUIA_Selected](MUI_Area/#MUIA_Selected) for this.

Waiting for [MUIA_Pressed](MUI_Area/#MUIA_Pressed) becoming FALSE is the usual way to react on button
gadgets.
...
### SEE ALSO
[MUIA_Selected](MUI_Area/#MUIA_Selected), [MUIA_Timer](MUI_Area/#MUIA_Timer), [MUIA_ShowSelState](MUI_Area/#MUIA_ShowSelState), [MUIA_InputMode](MUI_Area/#MUIA_InputMode)

## MUIA_RightEdge
### NAME
[MUIA_RightEdge](MUI_Area/#MUIA_RightEdge) -- V4 [..G], `LONG`, 0x8042ba82
...
### SEE ALSO
[MUIA_TopEdge](MUI_Area/#MUIA_TopEdge), [MUIA_Width](MUI_Area/#MUIA_Width), [MUIA_Height](MUI_Area/#MUIA_Height), [MUIA_LeftEdge](MUI_Area/#MUIA_LeftEdge), [MUIA_BottomEdge](MUI_Area/#MUIA_BottomEdge)

## MUIA_Selected
### NAME
[MUIA_Selected](MUI_Area/#MUIA_Selected) -- V4 [ISG], `BOOL`, 0x8042654b
...
[MUIA_ShowSelState](MUI_Area/#MUIA_ShowSelState) tag.

### SEE ALSO
[MUIA_Pressed](MUI_Area/#MUIA_Pressed), [MUIA_Timer](MUI_Area/#MUIA_Timer), [MUIA_ShowSelState](MUI_Area/#MUIA_ShowSelState), [MUIA_InputMode](MUI_Area/#MUIA_InputMode)

## MUIA_ShortHelp
### NAME
[MUIA_ShortHelp](MUI_Area/#MUIA_ShortHelp) -- V11 [ISG], `STRPTR`, 0x80428fe3

### FUNCTION
Specify a string that is to be used as bubble help for this object.

### SEE ALSO
[MUIM_CreateShortHelp](MUI_Area/#MUIM_CreateShortHelp), [MUIM_DeleteShortHelp](MUI_Area/#MUIM_DeleteShortHelp), [MUIM_CreateBubble](MUI_Area/#MUIM_CreateBubble),
[MUIM_DeleteBubble](MUI_Area/#MUIM_DeleteBubble)

## MUIA_ShowMe
### NAME
[MUIA_ShowMe](MUI_Area/#MUIA_ShowMe) -- V4 [ISG], `BOOL`, 0x80429ba8

### FUNCTION
Objects with this attribute set are not displayed. You can set [MUIA_ShowMe](MUI_Area/#MUIA_ShowMe)
...
[MUIA_ShowMe](MUI_Area/#MUIA_ShowMe) will just return the last set value or the default (TRUE).

## MUIA_ShowSelState
### NAME
[MUIA_ShowSelState](MUI_Area/#MUIA_ShowSelState) -- V4 [I..], `BOOL`, 0x8042caac
...
[MUIA_ShowSelState](MUI_Area/#MUIA_ShowSelState) to FALSE.

### SEE ALSO
[MUIA_Selected](MUI_Area/#MUIA_Selected)

## MUIA_TextColor
### NAME
[MUIA_TextColor](MUI_Area/#MUIA_TextColor) -- V22 [..G], `ULONG`, 0x8042dba6

### FUNCTION
Returns the RGB color without alpha channel (00RRGGBB) information of the text
associated with the object. This value is valid between [MUIM_Setup](MUI_Area/#MUIM_Setup) and
[MUIM_Cleanup](MUI_Area/#MUIM_Cleanup) only, otherwise it returns 0.

Do not cache this value and read it once per [MUIM_Draw](MUI_Area/#MUIM_Draw) call to support online
prefs changes.

## MUIA_Timer
### NAME
[MUIA_Timer](MUI_Area/#MUIA_Timer) -- V4 [..G], `LONG`, 0x80426435

### FUNCTION
[MUIA_Timer](MUI_Area/#MUIA_Timer) gets triggered when a relverify button is pressed and (after a
...
### SEE ALSO
[MUIA_Pressed](MUI_Area/#MUIA_Pressed), [MUIA_Selected](MUI_Area/#MUIA_Selected)

## MUIA_TopEdge
### NAME
[MUIA_TopEdge](MUI_Area/#MUIA_TopEdge) -- V4 [..G], `LONG`, 0x8042509b
...
### SEE ALSO
[MUIA_LeftEdge](MUI_Area/#MUIA_LeftEdge), [MUIA_Width](MUI_Area/#MUIA_Width), [MUIA_Height](MUI_Area/#MUIA_Height), [MUIA_RightEdge](MUI_Area/#MUIA_RightEdge), [MUIA_BottomEdge](MUI_Area/#MUIA_BottomEdge)

## MUIA_VertDisappear
### NAME
[MUIA_VertDisappear](MUI_Area/#MUIA_VertDisappear) -- V11 [ISG], `LONG`, 0x8042d12f
...
### SEE ALSO
[MUIA_HorizDisappear](MUI_Area/#MUIA_HorizDisappear)

## MUIA_VertWeight
### NAME
[MUIA_VertWeight](MUI_Area/#MUIA_VertWeight) -- V4 [ISG], `WORD`, 0x804298d0
...
## MUIA_Weight
### NAME
[MUIA_Weight](MUI_Area/#MUIA_Weight) -- V4 [I..], `WORD`, 0x80421d1f

### FUNCTION
This tag is a shorthand for [MUIA_HorizWeight](MUI_Area/#MUIA_HorizWeight) and [MUIA_VertWeight](MUI_Area/#MUIA_VertWeight), it sets
...
[MUIA_VertWeight](MUI_Area/#MUIA_VertWeight) for a (always fixed height) string gadget is useless.
...
### SEE ALSO
[MUIA_HorizWeight](MUI_Area/#MUIA_HorizWeight), [MUIA_VertWeight](MUI_Area/#MUIA_VertWeight)

## MUIA_Width
### NAME
[MUIA_Width](MUI_Area/#MUIA_Width) -- V4 [..G], `LONG`, 0x8042b59c
...
### SEE ALSO
[MUIA_TopEdge](MUI_Area/#MUIA_TopEdge), [MUIA_LeftEdge](MUI_Area/#MUIA_LeftEdge), [MUIA_Height](MUI_Area/#MUIA_Height), [MUIA_RightEdge](MUI_Area/#MUIA_RightEdge), [MUIA_BottomEdge](MUI_Area/#MUIA_BottomEdge)

## MUIA_Window
### NAME
[MUIA_Window](MUI_Area/#MUIA_Window) -- V4 [..G], `struct Window *`, 0x80421591
...
returned window pointer is valid between [MUIM_Show](MUI_Area/#MUIM_Show) and [MUIM_Hide](MUI_Area/#MUIM_Hide) only.

### SEE ALSO
[MUIA_Window_Window](MUI_Window/#MUIA_Window_Window)

## MUIA_WindowObject
### NAME
[MUIA_WindowObject](MUI_Area/#MUIA_WindowObject) -- V4 [..G], `Object *`, 0x8042669e
...
returned object pointer is valid between [MUIM_Setup](MUI_Area/#MUIM_Setup) and [MUIM_Cleanup](MUI_Area/#MUIM_Cleanup) only.

### SEE ALSO
[MUIA_ApplicationObject](MUI_Notify/#MUIA_ApplicationObject)

## MUIM_AskMinMax
### NAME
[MUIM_AskMinMax](MUI_Area/#MUIM_AskMinMax) -- V4, 0x80423874
...
## MUIM_Cleanup
### NAME
[MUIM_Cleanup](MUI_Area/#MUIM_Cleanup) -- V4, 0x8042d985
[For use within custom classes only]
...
## MUIM_ContextMenuAdd
### NAME
[MUIM_ContextMenuAdd](MUI_Area/#MUIM_ContextMenuAdd) -- V20, 0x8042df9e
...
context menu, it does not simply use the [MUIA_ContextMenu](MUI_Area/#MUIA_ContextMenu) field of Area
class. Instead, it sends a [MUIM_ContextMenuAdd](MUI_Area/#MUIM_ContextMenuAdd) to the object in question to
let it add its own context menu items to the given menustrip object.

When [MUIM_ContextMenuAdd](MUI_Area/#MUIM_ContextMenuAdd) reaches Area class, it will pass this method to its
...
which implements [MUIM_ContextMenuAdd](MUI_Area/#MUIM_ContextMenuAdd) and adds some items to the menustrip
object.
...
[MUIM_ContextMenuChoice](MUI_Area/#MUIM_ContextMenuChoice).

Even when implementing [MUIM_ContextMenuAdd](MUI_Area/#MUIM_ContextMenuAdd), you **MUST** set [MUIA_ContextMenu](MUI_Area/#MUIA_ContextMenu)
...
[MUIA_ContextMenu](MUI_Area/#MUIA_ContextMenu) in the instance data of Area class due to speed reasons.
...
### SEE ALSO
[MUIM_ContextMenuBuild](MUI_Area/#MUIM_ContextMenuBuild), [MUIA_ContextMenu](MUI_Area/#MUIA_ContextMenu), [MUIA_ContextMenuTrigger](MUI_Area/#MUIA_ContextMenuTrigger),
[MUIM_ContextMenuChoice](MUI_Area/#MUIM_ContextMenuChoice)

## MUIM_ContextMenuBuild
### NAME
[MUIM_ContextMenuBuild](MUI_Area/#MUIM_ContextMenuBuild) -- V11, 0x80429d2e

### SYNOPSIS
`DoMethod(obj, MUIM_ContextMenuBuild, LONG mx, LONG my);`

### FUNCTION
OBSOLETE - USE [MUIM_ContextMenuAdd](MUI_Area/#MUIM_ContextMenuAdd) in new code.

old documentation:
Allows dynamic creation of context menus. When MUI is about to show a new
context menu, it does not simply use the [MUIA_ContextMenu](MUI_Area/#MUIA_ContextMenu) field of Area
class. Instead, it sends a [MUIM_ContextMenuBuild](MUI_Area/#MUIM_ContextMenuBuild) to the object in question
and uses the return value as the new menustrip object.

When [MUIM_ContextMenuBuild](MUI_Area/#MUIM_ContextMenuBuild) reaches Area class, it just returns the contents
of [MUIA_ContextMenu](MUI_Area/#MUIA_ContextMenu) so you don't need to care about this method if you only
have static, non-changing context menus.

However, if your context menus depend on some internal states of your object
or on the mouse position within your object, you have to build a subclass
which overrides [MUIM_ContextMenuBuild](MUI_Area/#MUIM_ContextMenuBuild), creates a nice menustrip object and
returns it.
...
pre-MUI4 applications which used [MUIM_ContextMenuBuild](MUI_Area/#MUIM_ContextMenuBuild) to detect the right
...
killing it on the next invocation of [MUIM_ContextMenuBuild](MUI_Area/#MUIM_ContextMenuBuild) or on
OM_DISPOSE.

Even when implementing [MUIM_ContextMenuBuild](MUI_Area/#MUIM_ContextMenuBuild), you **MUST** set
[MUIA_ContextMenu](MUI_Area/#MUIA_ContextMenu) of your object to something different from NULL. MUI will
find out that your object actually has a popup menu by directly checking the
contents of [MUIA_ContextMenu](MUI_Area/#MUIA_ContextMenu) in the instance data of area class due to speed
reasons.

### SEE ALSO
[MUIM_ContextMenuAdd](MUI_Area/#MUIM_ContextMenuAdd), [MUIA_ContextMenu](MUI_Area/#MUIA_ContextMenu), [MUIA_ContextMenuTrigger](MUI_Area/#MUIA_ContextMenuTrigger),
[MUIM_ContextMenuChoice](MUI_Area/#MUIM_ContextMenuChoice)

## MUIM_ContextMenuChoice
### NAME
[MUIM_ContextMenuChoice](MUI_Area/#MUIM_ContextMenuChoice) -- V11, 0x80420f0e
...
### SEE ALSO
[MUIA_ContextMenuTrigger](MUI_Area/#MUIA_ContextMenuTrigger), [MUIM_ContextMenuChoice](MUI_Area/#MUIM_ContextMenuChoice), [MUIM_ContextMenuBuild](MUI_Area/#MUIM_ContextMenuBuild)

## MUIM_CreateBubble
### NAME
[MUIM_CreateBubble](MUI_Area/#MUIM_CreateBubble) -- V18, 0x80421c41

### SYNOPSIS
`DoMethod(obj, MUIM_CreateBubble, LONG x, LONG y, CONST_STRPTR txt, ULONG flags);`

### FUNCTION
Together with [MUIM_DeleteBubble](MUI_Area/#MUIM_DeleteBubble), this method provides an interface for MUI's
...
[MUIM_CreateBubble](MUI_Area/#MUIM_CreateBubble) creates a bubble at the specified coordinates with the
specified (textual) contents. It returns a bubble "handle" that has to be
passed to [MUIM_DeleteBubble](MUI_Area/#MUIM_DeleteBubble) when the bubble shall disappear.
...
Otherwise [MUIM_CreateBubble](MUI_Area/#MUIM_CreateBubble) returns NULL. You are responsible for deleting
the bubble **before** the object becomes invisible. Good place to remove a
custom bubble is e.g. the [MUIM_Hide](MUI_Area/#MUIM_Hide) method of your object.
...
**`CONST_STRPTR txt`**
     ...
     the object with [MUIM_CreateShortHelp](MUI_Area/#MUIM_CreateShortHelp) method for a text (like the
...
failure. You have to pass the bubble handle to [MUIM_DeleteBubble](MUI_Area/#MUIM_DeleteBubble) if you want
to delete the bubble later.

### SEE ALSO
[MUIM_DeleteBubble](MUI_Area/#MUIM_DeleteBubble), [MUIM_CreateShortHelp](MUI_Area/#MUIM_CreateShortHelp), [MUIM_DeleteShortHelp](MUI_Area/#MUIM_DeleteShortHelp),
[MUIA_ShortHelp](MUI_Area/#MUIA_ShortHelp)

## MUIM_CreateDragImage
### NAME
[MUIM_CreateDragImage](MUI_Area/#MUIM_CreateDragImage) -- V18, 0x8042eb6f
[For use within custom classes only]
...
### EXAMPLE
[MUIM_CreateDragImage](MUI_Area/#MUIM_CreateDragImage) method:
```c++
...
[MUIM_DeleteDragImage](MUI_Area/#MUIM_DeleteDragImage) method:
```c++
FreeBitMap(di->bm);
FreeVec(di);
```
...
### SEE ALSO
[MUIM_DeleteDragImage](MUI_Area/#MUIM_DeleteDragImage)

## MUIM_CreateShortHelp
### NAME
[MUIM_CreateShortHelp](MUI_Area/#MUIM_CreateShortHelp) -- V11, 0x80428e93
...
[MUIA_ShortHelp](MUI_Area/#MUIA_ShortHelp) field of area class. Instead, it sends a [MUIM_CreateShortHelp](MUI_Area/#MUIM_CreateShortHelp)
method to the object in question and uses the return value as text for the
bubble.

When [MUIM_CreateShortHelp](MUI_Area/#MUIM_CreateShortHelp) reaches Area class, it just returns the contents
of [MUIA_ShortHelp](MUI_Area/#MUIA_ShortHelp), so you needn't care about this method if you only have
...
subclass which overrides [MUIM_CreateShortHelp](MUI_Area/#MUIM_CreateShortHelp), creates a custom text string
and returns it.

You can dynamically allocate memory here. MUI will call the method
[MUIM_DeleteShortHelp](MUI_Area/#MUIM_DeleteShortHelp) after the bubble has disappeared to give you a chance
...
the following [MUIM_DeleteShortHelp](MUI_Area/#MUIM_DeleteShortHelp) method.

Even when overriding [MUIM_CreateShortHelp](MUI_Area/#MUIM_CreateShortHelp), you **MUST** set [MUIA_ShortHelp](MUI_Area/#MUIA_ShortHelp) of
...
[MUIA_ShortHelp](MUI_Area/#MUIA_ShortHelp) in the instance data of Area class due to speed reasons.
...
### SEE ALSO
[MUIM_DeleteShortHelp](MUI_Area/#MUIM_DeleteShortHelp), [MUIM_CreateBubble](MUI_Area/#MUIM_CreateBubble), [MUIM_DeleteBubble](MUI_Area/#MUIM_DeleteBubble), [MUIA_ShortHelp](MUI_Area/#MUIA_ShortHelp)

## MUIM_DeleteBubble
### NAME
[MUIM_DeleteBubble](MUI_Area/#MUIM_DeleteBubble) -- V18, 0x804211af

### SYNOPSIS
`DoMethod(obj, MUIM_DeleteBubble, APTR bubble);`

### FUNCTION
Together with [MUIM_CreateBubble](MUI_Area/#MUIM_CreateBubble), this method provides an interface for MUI's
bubble mechanism. Applications can use bubbles for their own purpose, e.g.
for indicating error conditions on certain gadgets.

[MUIM_DeleteBubble](MUI_Area/#MUIM_DeleteBubble) deletes a bubble that was previously created with
[MUIM_CreateBubble](MUI_Area/#MUIM_CreateBubble). Note that bubbles have to be deleted before an object
becomes invisible!

### INPUTS
**`APTR bubble`**
     pointer to black box bubble handle as returned by [MUIM_CreateBubble](MUI_Area/#MUIM_CreateBubble).

### RESULT
The bubble will be removed. The return value is undefined.

### SEE ALSO
[MUIM_CreateBubble](MUI_Area/#MUIM_CreateBubble), [MUIM_CreateShortHelp](MUI_Area/#MUIM_CreateShortHelp), [MUIM_DeleteShortHelp](MUI_Area/#MUIM_DeleteShortHelp)

## MUIM_DeleteDragImage
### NAME
[MUIM_DeleteDragImage](MUI_Area/#MUIM_DeleteDragImage) -- V18, 0x80423037
[For use within custom classes only]
...
### FUNCTION
Free all stuff allocated during [MUIM_CreateDragImage](MUI_Area/#MUIM_CreateDragImage).
...
### SEE ALSO
[MUIM_CreateDragImage](MUI_Area/#MUIM_CreateDragImage)

## MUIM_DeleteShortHelp
### NAME
[MUIM_DeleteShortHelp](MUI_Area/#MUIM_DeleteShortHelp) -- V11, 0x8042d35a

### SYNOPSIS
`DoMethod(obj, MUIM_DeleteShortHelp, STRPTR help);`

### FUNCTION
Delete the string that [MUIM_CreateShortHelp](MUI_Area/#MUIM_CreateShortHelp) might have allocated.

MUI will call this method if you returned a custom text in
[MUIM_CreateShortHelp](MUI_Area/#MUIM_CreateShortHelp) when the bubble has disappeared.

You can free memory that you allocated for the dynamic bubble text here.

### INPUTS
**`STRPTR help`**
     the STRPTR you previously returned in [MUIM_CreateShortHelp](MUI_Area/#MUIM_CreateShortHelp).

### RESULT
Return NULL in every case.

### SEE ALSO
[MUIM_CreateShortHelp](MUI_Area/#MUIM_CreateShortHelp), [MUIM_CreateBubble](MUI_Area/#MUIM_CreateBubble), [MUIM_DeleteBubble](MUI_Area/#MUIM_DeleteBubble), [MUIA_ShortHelp](MUI_Area/#MUIA_ShortHelp)

## MUIM_DoDrag
### NAME
[MUIM_DoDrag](MUI_Area/#MUIM_DoDrag) -- V20, 0x804216bb
...
### SEE ALSO
[MUIA_Draggable](MUI_Area/#MUIA_Draggable), [MUIM_DragBegin](MUI_Area/#MUIM_DragBegin), [MUIM_DragQuery](MUI_Area/#MUIM_DragQuery), [MUIM_DragFinish](MUI_Area/#MUIM_DragFinish),
[MUIM_DragReport](MUI_Area/#MUIM_DragReport), [MUIM_DragDrop](MUI_Area/#MUIM_DragDrop)

## MUIM_DragBegin
### NAME
[MUIM_DragBegin](MUI_Area/#MUIM_DragBegin) -- V11, 0x8042c03a
...
previous [MUIM_DragQuery](MUI_Area/#MUIM_DragQuery).

### SEE ALSO
[MUIM_DragQuery](MUI_Area/#MUIM_DragQuery), [MUIM_DragFinish](MUI_Area/#MUIM_DragFinish), [MUIM_DragReport](MUI_Area/#MUIM_DragReport), [MUIM_DragDrop](MUI_Area/#MUIM_DragDrop)

## MUIM_DragDrop
### NAME
[MUIM_DragDrop](MUI_Area/#MUIM_DragDrop) -- V11, 0x8042c555
...
### SEE ALSO
[MUIM_DragBegin](MUI_Area/#MUIM_DragBegin), [MUIM_DragFinish](MUI_Area/#MUIM_DragFinish), [MUIM_DragReport](MUI_Area/#MUIM_DragReport), [MUIM_DragQuery](MUI_Area/#MUIM_DragQuery)

## MUIM_DragEvent
### NAME
[MUIM_DragEvent](MUI_Area/#MUIM_DragEvent) -- V20, 0x8042b774
[For use within custom classes only]
...
**`ULONG flags`**
     ...
     flags exists:
       * MUIF_DRAGEVENT_REDRAW: set by the overloader in case the
         MUI_DragImage was modified during [MUIM_DragEvent](MUI_Area/#MUIM_DragEvent).
       * MUIF_DRAGEVENT_FOREIGNDROP: set by the overloader in case
         it can drop to a foreign window, the actual drop must be
         implemented in the Application's [MUIM_DragDrop](MUI_Area/#MUIM_DragDrop) method.
       * MUIF_DRAGEVENT_MOUSECHANGED: set by the overloader to
         force a custom mouse pointer instead of the one picked by
         MUI.

### SEE ALSO
[MUIA_PointerType](MUI_Area/#MUIA_PointerType)

## MUIM_DragFinish
### NAME
[MUIM_DragFinish](MUI_Area/#MUIM_DragFinish) -- V11, 0x804251f0
...
**`LONG dropfollows`**
     a flag indicating whether a [MUIM_DragDrop](MUI_Area/#MUIM_DragDrop) message will follow
     for the receiving object.

### SEE ALSO
[MUIM_DragQuery](MUI_Area/#MUIM_DragQuery), [MUIM_DragBegin](MUI_Area/#MUIM_DragBegin), [MUIM_DragReport](MUI_Area/#MUIM_DragReport), [MUIM_DragDrop](MUI_Area/#MUIM_DragDrop)

## MUIM_DragQuery
### NAME
[MUIM_DragQuery](MUI_Area/#MUIM_DragQuery) -- V11, 0x80420261
...
MUI controls the D&D actions with a set of five methods: [MUIM_DragQuery](MUI_Area/#MUIM_DragQuery),
[MUIM_DragBegin](MUI_Area/#MUIM_DragBegin), [MUIM_DragReport](MUI_Area/#MUIM_DragReport), [MUIM_DragDrop](MUI_Area/#MUIM_DragDrop) and [MUIM_DragFinish](MUI_Area/#MUIM_DragFinish).
...
[MUIM_DragQuery](MUI_Area/#MUIM_DragQuery) method. An object that receives [MUIM_DragQuery](MUI_Area/#MUIM_DragQuery) can now
...
in D&D business, the [MUIM_DragQuery](MUI_Area/#MUIM_DragQuery) is first sent to the deepest nested
object (the cycle gadget in the example above). If this one doesn't respond,
MUI sends a [MUIM_DragQuery](MUI_Area/#MUIM_DragQuery) to its parent group and so on until it either
...
current state by receiving a [MUIM_DragBegin](MUI_Area/#MUIM_DragBegin) method. This method, when
reaching area class, e.g. draws a special frame around the object to
indicate the current state to the user.

The opposite of [MUIM_DragBegin](MUI_Area/#MUIM_DragBegin) is [MUIM_DragFinish](MUI_Area/#MUIM_DragFinish) and will be sent as soon
as the object stops being destination of the drag process, i.e. because the
user aborted the drag or moved out of the bounding box. [MUIM_DragFinish](MUI_Area/#MUIM_DragFinish)
will also be sent after a successful drop, you can rely on receiving a
[MUIM_DragFinish](MUI_Area/#MUIM_DragFinish) if you received a [MUIM_DragBegin](MUI_Area/#MUIM_DragBegin) before. Furthermore, only
one object will be between [MUIM_DragBegin](MUI_Area/#MUIM_DragBegin) and [MUIM_DragFinish](MUI_Area/#MUIM_DragFinish) at any time.

Active destination objects (between [MUIM_DragBegin](MUI_Area/#MUIM_DragBegin) and [MUIM_DragFinish](MUI_Area/#MUIM_DragFinish))
receive [MUIM_DragReport](MUI_Area/#MUIM_DragReport) methods as long as the user moves the mouse within
the object. [MUIM_DragReport](MUI_Area/#MUIM_DragReport) contains the mouse coordinates, so the object
...
[MUIM_DragDrop](MUI_Area/#MUIM_DragDrop) method and can perform whatever operation it thinks is suited
...
fact, [MUIM_DragQuery](MUI_Area/#MUIM_DragQuery) and [MUIM_DragDrop](MUI_Area/#MUIM_DragDrop) are enough for almost all D&D
...
### SEE ALSO
[MUIM_DragBegin](MUI_Area/#MUIM_DragBegin), [MUIM_DragFinish](MUI_Area/#MUIM_DragFinish), [MUIM_DragReport](MUI_Area/#MUIM_DragReport), [MUIM_DragDrop](MUI_Area/#MUIM_DragDrop)

## MUIM_DragReport
### NAME
[MUIM_DragReport](MUI_Area/#MUIM_DragReport) -- V11, 0x8042edad
...
### SEE ALSO
[MUIM_DragQuery](MUI_Area/#MUIM_DragQuery), [MUIM_DragFinish](MUI_Area/#MUIM_DragFinish), [MUIM_DragBegin](MUI_Area/#MUIM_DragBegin), [MUIM_DragDrop](MUI_Area/#MUIM_DragDrop)

## MUIM_Draw
### NAME
[MUIM_Draw](MUI_Area/#MUIM_Draw) -- V4, 0x80426f3f
[For use within custom classes only]
...
## MUIM_DrawBackground
### NAME
[MUIM_DrawBackground](MUI_Area/#MUIM_DrawBackground) -- V11, 0x804238ca

### SYNOPSIS
`DoMethod(obj, MUIM_DrawBackground, LONG left, LONG top, LONG width, LONG height, LONG xoffset, LONG yoffset, LONG flags);`

### FUNCTION
If you decided to use [MUIA_FillArea](MUI_Area/#MUIA_FillArea), FALSE for your custom class, i.e. if
...
[MUIA_Background](MUI_Area/#MUIA_Background).
...
### NAME
[MUIM_DrawBackgroundParent](MUI_Area/#MUIM_DrawBackgroundParent) -- V20, 0x804240e7
...
### FUNCTION
Just like [MUIM_DrawBackground](MUI_Area/#MUIM_DrawBackground) to fill the object's background with the
...
### SEE ALSO
[MUIM_DrawBackground](MUI_Area/#MUIM_DrawBackground)

## MUIM_GoActive
### NAME
[MUIM_GoActive](MUI_Area/#MUIM_GoActive) -- V8, 0x8042491a
[For use within custom classes only]
...
## MUIM_GoInactive
### NAME
[MUIM_GoInactive](MUI_Area/#MUIM_GoInactive) -- V8, 0x80422c0c
[For use within custom classes only]
...
## MUIM_HandleEvent
### NAME
[MUIM_HandleEvent](MUI_Area/#MUIM_HandleEvent) -- V16, 0x80426d66
[For use within custom classes only]
...
### SEE ALSO
[MUIM_Window_AddEventHandler](MUI_Window/#MUIM_Window_AddEventHandler), [MUIM_Window_RemEventHandler](MUI_Window/#MUIM_Window_RemEventHandler)

## MUIM_HandleInput
### NAME
[MUIM_HandleInput](MUI_Area/#MUIM_HandleInput) -- V4, 0x80422a1a
[For use within custom classes only]
...
## MUIM_Hide
### NAME
[MUIM_Hide](MUI_Area/#MUIM_Hide) -- V4, 0x8042f20f
[For use within custom classes only]
...
## MUIM_Layout
### NAME
[MUIM_Layout](MUI_Area/#MUIM_Layout) -- V4, 0x8042845b
...
Implementing [MUIM_Layout](MUI_Area/#MUIM_Layout) is basically the same as specifying a layout hook for
...
### SEE ALSO
muimaster.library/MUI_Layout(), [MUIA_Group_LayoutHook](MUI_Group/#MUIA_Group_LayoutHook)

## MUIM_Relayout
### NAME
[MUIM_Relayout](MUI_Area/#MUIM_Relayout) -- V22, 0x8042b381
...
### SEE ALSO
[MUIM_Cleanup](MUI_Area/#MUIM_Cleanup), [MUIM_Hide](MUI_Area/#MUIM_Hide), [MUIM_Setup](MUI_Area/#MUIM_Setup), [MUIM_Show](MUI_Area/#MUIM_Show)

## MUIM_Setup
### NAME
[MUIM_Setup](MUI_Area/#MUIM_Setup) -- V4, 0x80428354
[For use within custom classes only]
...
## MUIM_Show
### NAME
[MUIM_Show](MUI_Area/#MUIM_Show) -- V4, 0x8042cc84
[For use within custom classes only]
...
## MUIM_Text
### NAME
[MUIM_Text](MUI_Area/#MUIM_Text) -- V20, 0x8042ee70
...
preparse string. Refer to [MUIA_Text_Contents](MUI_Text/#MUIA_Text_Contents) for all possible sequences.

Make sure to specify a rectangle which resides in the object's area,
otherwise the object's frame might be overdrawn.

It is recommended to calculate the text's dimensions via [MUIM_TextDim](MUI_Area/#MUIM_TextDim), i.e.
during [MUIM_AskMinMax](MUI_Area/#MUIM_AskMinMax), to ensure that the text is fully visible and will not
...
### SEE ALSO
[MUIM_TextDim](MUI_Area/#MUIM_TextDim), [MUIA_Text_Contents](MUI_Text/#MUIA_Text_Contents), [MUIA_Text_PreParse](MUI_Text/#MUIA_Text_PreParse)

## MUIM_TextDim
### NAME
[MUIM_TextDim](MUI_Area/#MUIM_TextDim) -- V20, 0x80422ad7
...
### SEE ALSO
[MUIM_Text](MUI_Area/#MUIM_Text), [MUIA_Text_Contents](MUI_Text/#MUIA_Text_Contents), [MUIA_Text_PreParse](MUI_Text/#MUIA_Text_PreParse)

## MUIM_UpdateConfig
### NAME
[MUIM_UpdateConfig](MUI_Area/#MUIM_UpdateConfig) -- V20, 0x8042b0a9
...
### NAME
[MUIM_WhichPointerType](MUI_Area/#MUIM_WhichPointerType) -- V20, 0x8042e212
